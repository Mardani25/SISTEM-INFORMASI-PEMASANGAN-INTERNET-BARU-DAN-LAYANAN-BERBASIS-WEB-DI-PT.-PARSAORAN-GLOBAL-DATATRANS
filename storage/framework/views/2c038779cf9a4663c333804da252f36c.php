...
<tbody>
  ...
  <tr>
    ...
    <td><?php echo e($jadwal->user->name ?? '-'); ?></td>
    ...
    <td><?php echo e($jadwal->pemesanan->user->name ?? $jadwal->pemesanan->pelanggan->name ?? '-'); ?></td>
    <td><?php echo e($jadwal->pemesanan->user->alamat ?? $jadwal->pemesanan->pelanggan->alamat ?? '-'); ?></td>
    <td><?php echo e($jadwal->pemesanan->user->telepon ?? $jadwal->pemesanan->pelanggan->telepon ?? '-'); ?></td>
    ...
    <td class="text-center">
      ...
      <?php elseif($jadwal->bukti_foto): ?>
        <a href="<?php echo e(asset('storage/public/bukti_foto/' . $jadwal->bukti_foto)); ?>" target="_blank" class="btn btn-outline-info btn-sm">Lihat</a>
      <?php else: ?>
...
<?php /**PATH /home/u816639003/domains/ionwifi.site/public_html/resources/views/admin/teknisi/jadwal_index.blade.php ENDPATH**/ ?>