...
<head>
    ...
    <!-- Snap Midtrans -->
<script src="<?php echo e(config('midtrans.isProduction') ? 'https://app.midtrans.com/snap/snap.js' : 'https://app.sandbox.midtrans.com/snap/snap.js'); ?>" data-client-key="<?php echo e(config('midtrans.clientKey')); ?>"></script>
...
<div class="container">
    <div class="card p-4">
        ...
        <div class="text-center mb-3">
            <p class="mb-1">Layanan: <strong><?php echo e($pemesanan->layanan->nama_layanan); ?></strong></p>
            <p class="mb-4">Total: <strong>Rp<?php echo e(number_format($pemesanan->layanan->harga, 0, ',', '.')); ?></strong></p>
...
<?php /**PATH /home/u816639003/domains/ionwifi.site/public_html/resources/views/pembayaran/index.blade.php ENDPATH**/ ?>