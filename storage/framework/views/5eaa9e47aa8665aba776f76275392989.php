  ...
  <div class="container">
    ...
    <div class="d-none d-lg-block">
      <p class="mb-0 register-link">
        <a href="<?php echo e(route('register')); ?>" class="mr-3" style="color: black;">Daftar</a>
        <a href="<?php echo e(route('login')); ?>" style="color: black;">Login</a>
      </p>
    </div>
            ...
            <div class="card-body d-flex flex-column">
              ...
              <div class="mt-auto">
                ...
                <?php if(auth()->guard()->guest()): ?>
                  <a href="<?php echo e(route('login')); ?>" class="btn btn-primary w-100">Pilih Paket</a>
                <?php endif; ?>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-6 mb-4">
          <img src="<?php echo e(asset('images/pt.jpg')); ?>" alt="Tentang PT Parsaoran" class="img-fluid rounded shadow">
        </div>
        <div class="col-md-6">
...
</html><?php /**PATH /home/u816639003/domains/ionwifi.site/public_html/resources/views/dashboard/welcome.blade.php ENDPATH**/ ?>