...
<table class="table table-bordered">
    ...
    <tbody>
        <?php $__currentLoopData = $pembayarans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pembayaran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                $pemesan = $pembayaran->pemesanan; // Ambil relasi pemesanan dari pembayaran
            ?>
            <tr>
                <td><?php echo e($pemesan->id); ?></td>
                <td><?php echo e($pemesan->pelanggan->user->name ?? 'Tidak Tersedia'); ?></td>
                <td><?php echo e($pemesan->pelanggan->user->telepon ?? '-'); ?></td>
                <td><?php echo e($pemesan->pelanggan->user->alamat ?? '-'); ?></td>
                <td><?php echo e($pemesan->layanan->nama_layanan); ?></td>
                <td>Rp <?php echo e(number_format($pemesan->layanan->harga, 0, ',', '.')); ?></td>
...
<?php /**PATH C:\laragon\www\sistem-pemesanan-dan-pemasangan1\resources\views/pemesanan/indexte.blade.php ENDPATH**/ ?>