        ...
        <div class="card-body table-responsive">
            <table class="table table-bordered align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        <form action="/layanan/<?php echo e($data->id); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                            <td>
                                <input type="text" name="nama_layanan" class="form-control" value="<?php echo e($data->nama_layanan); ?>" />
                            </td>
                            <td>
                                <input type="text" name="kecepatan" class="form-control" value="<?php echo e($data->kecepatan); ?>" />
                            </td>
                            <td>
                                <input type="text" name="harga" class="form-control harga-format" value="<?php echo e(number_format($data->harga, 0, ',', '.')); ?>" />
                            </td>
                        ...
                        <td class="text-center">
                            <form action="/layanan/<?php echo e($data->id); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus layanan ini?');">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH /home/u816639003/domains/ionwifi.site/public_html/resources/views/layanan/index.blade.php ENDPATH**/ ?>